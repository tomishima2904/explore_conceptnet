...
if __name__ == "__main__":
    ...
    parser.add_argument('--num_pre_return_sequences', type=int, default=30, help="提案手法による選択を行う前に生成する理由の数")
    parser.add_argument('--num_return_sequences', type=int, default=3, help="提案手法による選択を行った後に返す理由の数")
    parser.add_argument('--num_refs', type=int, default=3)
    parser.add_argument('--seed', type=int, default=19990429)
    parser.add_argument('--template_dir', type=str, default="datasets/連想語頻度表/templates/master30")
